...
<body id="home">
	...
	<h4 class="ui inverted red block header" >自动回答功能展示<a href="/qademo/home" style='float:right'>首页</a> <a style='float:right'>| </a>  <a href="/qademo/soundUpdate" style='float:right'>语音展示 </a></h4>
	...
	<table class="ui table segment">
			...
			<tbody>
				<tr>
					<td>
						<div class="field">							
							<textarea rows="10" cols="80" name="question" >${question} </textarea>
						</div>							
					</td>
					<td>
						<div class="field">							
